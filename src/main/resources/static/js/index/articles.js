    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            layui.config({
                ...
                laypage.render({
                    elem: 'paging-div'
                    , count: pageRow,//数据总数，从服务端得到 pageRow
                    // skip: true,
                    curr: pageCurr,//当前页
                    limit: 5,//一页数
    ...
    function Renderer(data) {
        ...
        $.each(data, function (index, element) {
            ...
            str += "<div class=\"item\">\n" +
                ...
                "            <button class=\"layui-btn layui-btn-danger new-icon\">"+element['articleCategories']+"</button>\n" +//分类
                "                </h3>\n" +
                "                <h5>" + element['articleTags'] +
                "&nbsp;&nbsp;&nbsp;"+ element['publishDate'] +
                "                 </h5>\n" +//分类
                "                <p>\n" + element['articleContent'] +//文章内容
                "                </p>\n" +
                "            <a href=\"details/" + element['id'] + "\" class=\"go-icon\"></a>\n" +
                "                </div>\n" +
                "                </div>\n" +
                "                </div>\n" +
                "                </div>\n" +
